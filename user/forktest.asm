...
forktest(void)
{
  ...
  34:	41050513          	addi	a0,a0,1040 # 440 <wait2+0xe>
  ...
  56:	43e50513          	addi	a0,a0,1086 # 490 <wait2+0x5e>
  ...
  6c:	3e850513          	addi	a0,a0,1000 # 450 <wait2+0x1e>
  ...
  7e:	3ee50513          	addi	a0,a0,1006 # 468 <wait2+0x36>
  ...
  ae:	3d650513          	addi	a0,a0,982 # 480 <wait2+0x4e>
